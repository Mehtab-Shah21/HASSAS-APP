            ...
            {loading ? (
              ...
              services.map((s) => (
                <tr key={s.id} className="hover:bg-slate-50">
                  ...
                  <td className="px-4 py-2 text-slate-600">{categoryName(s.category_id)}</td>
                  <td className="px-4 py-2 text-slate-600">{s.price.toFixed(2)}</td>
                  <td className="px-4 py-2 text-slate-600">{s.govt_fee.toFixed(2)}</td>
                  <td className="px-4 py-2 text-slate-600">{s.taxable ? "Yes" : "No"}</td>
                  {isAdmin && (
                    <td className="px-4 py-2 text-right">
                      <button onClick={() => setEditingService(s)} className="text-indigo-600 hover:underline">
                        Edit
                      </button>
                    </td>
                  )}
